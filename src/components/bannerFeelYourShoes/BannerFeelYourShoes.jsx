  ...
  return (
    ...
    <div className='trendSection'>
      <article className='articleSnickers'>
        <img src="https://www.tint-store.com/de-de/Data/Images/Big/adidas-originals-forum-low-weiss-schwarz-fy7757-lifestyle_right_back.jpg" alt="" className='articleImg'/>
      ...
      <article className='articleSnickers'>
        <img src="https://assets.adidas.com/images/w_600,f_auto,q_auto/87e278ebf8cf4706a3bda7fa00e450a5_9366/Busenitz_Pro_Schuh_Schwarz_G48060_01_standard.jpg" alt="" className='articleImg'/>
        <div className='containerInfo'>
          <div className='infoAndPrice'>
